...
function CreateContent() {
  ...
  useEffect(() => {
    if (!videoJobId || status !== "video-generating") return;
            ...
            <aside className="result-section">
              ...
              {(status === "scripts-ready" || status === "video-generating" || status === "video-ready") && (
                <div className="card result-card result-done">
                      ...
                      <div className="shot-list">
                        ...
                        {selectedVariant.shotList.map((shot) => (
                          <div key={shot.beat} className="shot-item">
                            <span className="shot-meta">Beat {shot.beat} · {shot.timeRange} · {shot.intent}</span>
                  ...
                  {videoUrl && (
                    <a href={videoUrl} target="_blank" rel="noopener noreferrer" className="btn btn-secondary">
                      Open video
                    </a>
                  )}
                </div>
              ...
              {status === "idle" && (
                <div className="card result-card result-idle">
                  <p>1) Fill fields 2) Generate scripts 3) Choose variant 4) Generate video.</p>
                </div>
              )}
            </aside>
          </div>
